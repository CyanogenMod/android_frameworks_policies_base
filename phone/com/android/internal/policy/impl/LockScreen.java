...
class LockScreen extends LinearLayout implements KeyguardScreen, KeyguardUpdateMonitor.InfoCallback,
    ...
    private boolean mGestureUnlockHide;
    ...
    LockScreen(Context context, Configuration configuration, LockPatternUtils lockPatternUtils,
        ...
        mGestureUnlockHide = (Settings.System.getInt(context.getContentResolver(),
                Settings.System.LOCKSCREEN_GESTURES_DISABLE_UNLOCK, 0) == 1);
        if (!mGestureActive) {
            mGestureTrail = false;
            mGestureUnlockHide = false;
        }
